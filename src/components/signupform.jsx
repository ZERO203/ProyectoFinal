...
function SignUpForm() {
    ...
    return (
        ...
        <div class="container flex flex-start mt-24 min-h-[90vh] px-6 mx-auto">
            <form class="w-full max-w-md">
                ...
                <div class="relative flex items-center mt-8">
                    ...
                    <input type="text" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" fill placeholder="Nombre completo" required />
                </div>
                ...
                <div class="relative flex items-center mt-4">
                    ...
                    <input type="password" class="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Repetir contraseña"  required/>
                </div>
