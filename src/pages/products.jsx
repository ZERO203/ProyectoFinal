        ...
        <div className="flex flex-wrap -m-4">
          {products.map((product) => (
            ...
            <div key={product.id} className="flex flex-col items-center justify-center w-full max-w-sm mx-auto mb-10">
              <img src={product.img} alt={product.img} className="w-full h-64 bg-gray-300 bg-center bg-cover rounded-lg shadow-md" />
